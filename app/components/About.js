        ...
        <div className="about__grid">
          <div className="about__content animate-on-scroll">
            <div className="about__text">
              ...
              <p>I&apos;m the <strong>co-founder of Afrolal Tech</strong> — a digital innovation company delivering world-class web &amp; mobile solutions, SEO analytics, and AI-powered strategies. I&apos;m passionate about creating technology that solves real-world problems and I&apos;m <strong>available for freelance work</strong> globally.</p>
            </div>
